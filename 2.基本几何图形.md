...
## 2.4 箭头
由于[Line](#line-线)是[TipableVMobject](https://docs.manim.community/en/v0.19.2/reference/manim.mobject.geometry.arc.TipableVMobject.html)的子类，所以Line及其子类可用`add_tip()`来添加箭头的尖端。使用`tip`属性或`get_tip()`之类的方法来访问尖端。
