...
- [三、图形样貌](#三图形样貌)
  ...
  - [3.2 填充](#32-填充)
  - [3.3 颜色](#33-颜色)
  - [3.4 CapStyleType](#34-capstyletype)
  - [3.5 LineJointType（线条连接的类型）](#35-linejointtype线条连接的类型)
...
## 3.4 CapStyleType
[CapStyleType参考链接](https://docs.manim.community/en/v0.20.0/reference/manim.constants.CapStyleType.html)
```Python
...
## 3.5 LineJointType（线条连接的类型）
[LineJointType参考链接](https://docs.manim.community/en/v0.20.0/reference/manim.constants.LineJointType.html)
```Python
