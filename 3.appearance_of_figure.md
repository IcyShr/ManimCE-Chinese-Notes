...
## 3.4 CapStyleType
[CapStyleType参考链接](https://docs.manim.community/en/v0.20.1/reference/manim.constants.CapStyleType.html)
```Python
...
[LineJointType参考链接](https://docs.manim.community/en/v0.20.1/reference/manim.constants.LineJointType.html)
```Python
